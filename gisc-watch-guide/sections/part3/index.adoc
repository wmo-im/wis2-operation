...
- Most tickets are expected to be created automatically by both Global Monitor operators 
- On 21 May 2026, both GMs enabled automatic ticket creation in the production JIRA platform. At present, only alert rules defined as “critical” severity in the WIS2 Metric Hierarchy repository (https://github.com/wmo-im/wis2-metric-hierarchy/tree/main/alerts) will trigger JIRA ticket generation.
...
-  Tickets can only be closed by the assignee with a summary. The reporter may reopen the tickets as needed.
